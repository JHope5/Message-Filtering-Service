...
namespace NapierBank
{
    public partial class SendSMS : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string body = BodyCreator(message, number);
            ...
            else
            {
                ...
                {
                  messageID = IDCreator(),
                  messageBody = BodyCreator(message, number)
                });
        ...
        private string BodyCreator(string message, string number)
        {
            string body = "Sender: " + number + " - Message Text: " + message;
            return body;
        }
